...
public enum PhotoModeWeatherPreset {
    ...
    SUNNY("sunny", "panoramica.photo_mode.weather.sunny", 0.0F, 0.0F),
    RAINY("rainy", "panoramica.photo_mode.weather.rainy", 1.0F, 0.0F),
    THUNDERING("thundering", "panoramica.photo_mode.weather.thundering", 1.0F, 1.0F);
