...
public enum PhotoModeTimePreset {
    ...
    MORNING("morning", "panoramica.photo_mode.time.morning", 1_000L),
    NOON("noon", "panoramica.photo_mode.time.noon", 6_000L),
    EVENING("evening", "panoramica.photo_mode.time.evening", 12_000L),
    NIGHT("night", "panoramica.photo_mode.time.night", 18_000L);
