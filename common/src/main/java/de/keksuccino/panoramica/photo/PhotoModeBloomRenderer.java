...
final class PhotoModeBloomRenderer {
    ...
    private static final Identifier PREFILTER_PIPELINE_ID = Identifier.fromNamespaceAndPath(Panoramica.MOD_ID, "pipeline/photo_bloom_prefilter");
    private static final Identifier DOWNSAMPLE_PIPELINE_ID = Identifier.fromNamespaceAndPath(Panoramica.MOD_ID, "pipeline/photo_bloom_downsample");
    private static final Identifier BLUR_HORIZONTAL_PIPELINE_ID = Identifier.fromNamespaceAndPath(Panoramica.MOD_ID, "pipeline/photo_bloom_blur_horizontal");
    private static final Identifier BLUR_VERTICAL_PIPELINE_ID = Identifier.fromNamespaceAndPath(Panoramica.MOD_ID, "pipeline/photo_bloom_blur_vertical");
    private static final Identifier COMPOSITE_PIPELINE_ID = Identifier.fromNamespaceAndPath(Panoramica.MOD_ID, "pipeline/photo_bloom_composite");
    private static final Identifier COPY_PIPELINE_ID = Identifier.fromNamespaceAndPath(Panoramica.MOD_ID, "pipeline/photo_bloom_copy");
    private static final Identifier PREFILTER_SHADER_ID = Identifier.fromNamespaceAndPath(Panoramica.MOD_ID, "post/bloom_prefilter");
    private static final Identifier DOWNSAMPLE_SHADER_ID = Identifier.fromNamespaceAndPath(Panoramica.MOD_ID, "post/bloom_downsample");
    private static final Identifier BLUR_HORIZONTAL_SHADER_ID = Identifier.fromNamespaceAndPath(Panoramica.MOD_ID, "post/bloom_blur_horizontal");
    private static final Identifier BLUR_VERTICAL_SHADER_ID = Identifier.fromNamespaceAndPath(Panoramica.MOD_ID, "post/bloom_blur_vertical");
    private static final Identifier COMPOSITE_SHADER_ID = Identifier.fromNamespaceAndPath(Panoramica.MOD_ID, "post/bloom_composite");
    ...
    static void process(
        ...
        prefilterPass.executes(() -> drawSingleInputPass(
                ...
                "Panoramica photo bloom prefilter",
                true
        ));

        FramePass halfBlurHorizontalPass = frame.addPass("panoramica_bloom_half_blur_horizontal");
        ...
        halfBlurHorizontalPass.executes(() -> drawSingleInputPass(
                ...
                halfPrefilterOutput.get(),
                halfBlurOutput.get(),
                "Panoramica photo bloom half horizontal",
                false
        ));

        FramePass halfBlurVerticalPass = frame.addPass("panoramica_bloom_half_blur_vertical");
        ...
        halfBlurVerticalPass.executes(() -> drawSingleInputPass(
                ...
                halfBlurOutput.get(),
                halfBloomOutput.get(),
                "Panoramica photo bloom half vertical",
                false
        ));

        FramePass downsamplePass = frame.addPass("panoramica_bloom_downsample");
        ...
        downsamplePass.executes(() -> drawSingleInputPass(
                ...
                "Panoramica photo bloom downsample",
                false
        ));

        FramePass quarterBlurHorizontalPass = frame.addPass("panoramica_bloom_quarter_blur_horizontal");
        ...
        quarterBlurHorizontalPass.executes(() -> drawSingleInputPass(
                ...
                "Panoramica photo bloom quarter horizontal",
                false
        ));

        FramePass quarterBlurVerticalPass = frame.addPass("panoramica_bloom_quarter_blur_vertical");
        ...
        quarterBlurVerticalPass.executes(() -> drawSingleInputPass(
                ...
                "Panoramica photo bloom quarter vertical",
                false
        ));

        FramePass compositePass = frame.addPass("panoramica_bloom_composite");
        ...
        FramePass copyPass = frame.addPass("panoramica_bloom_copy");
    ...
    private static void drawCompositePass(
        ...
        try (RenderPass renderPass = commandEncoder.createRenderPass(
                () -> "Panoramica photo bloom composite",
                outputColor,
                Optional.empty(),
                null,
                OptionalDouble.empty()
    ...
    private static final class Resources implements AutoCloseable {
        ...
        private final ProjectionMatrixBuffer postProjectionMatrixBuffer = new ProjectionMatrixBuffer("panoramica photo bloom");
        ...
        private final MappableRingBuffer compositeSamplerInfoBuffer = new MappableRingBuffer(() -> "Panoramica photo bloom Composite SamplerInfo", 130, COMPOSITE_SAMPLER_INFO_SIZE);
        private final MappableRingBuffer bloomConfigBuffer = new MappableRingBuffer(() -> "Panoramica photo bloom Config", 130, BLOOM_CONFIG_SIZE);
        ...
        private static MappableRingBuffer samplerInfoBuffer(@NotNull String passName) {
            return new MappableRingBuffer(() -> "Panoramica photo bloom " + passName + " SamplerInfo", 130, SAMPLER_INFO_SIZE);
        }
