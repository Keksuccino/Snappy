...
public enum PhotoModeStylizePreset {
    ...
    NONE("none", "panoramica.photo_mode.stylize.none", 0),
    COLOR_SKETCH("color_sketch", "panoramica.photo_mode.stylize.color_sketch", 1),
    PENCIL_SKETCH("pencil_sketch", "panoramica.photo_mode.stylize.pencil_sketch", 2),
    CARTOON("cartoon", "panoramica.photo_mode.stylize.cartoon", 3),
    THE_FUUUUUTURE("the_fuuuuuture", "panoramica.photo_mode.stylize.the_fuuuuuture", 4);
