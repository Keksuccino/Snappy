...
public class Panoramica {
    ...
    public static void init() {
        ...
        if (Services.PLATFORM.isOnClient()) {
            ...
            LOGGER.info("[PANORAMICA] Starting version " + VERSION + " on " + Services.PLATFORM.getPlatformDisplayName() + "..");

        } else {

            LOGGER.warn("[PANORAMICA] Disabling 'Panoramica' since it's a client-side mod and current environment is server!");
