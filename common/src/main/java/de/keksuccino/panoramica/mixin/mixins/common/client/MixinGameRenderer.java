...
import de.keksuccino.panoramica.ZoomHandler;
...
public class MixinGameRenderer {
    ...
    private boolean wrap_renderItemInHand_Panoramica(GameRenderer instance, CameraRenderState cameraState, float deltaPartialTick, Matrix4fc modelViewMatrix) {
