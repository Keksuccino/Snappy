...
public class Options extends AbstractOptions {
    ...
    protected final Config config = new Config(Snappy.MOD_DIR.getAbsolutePath().replace("\\", "/") + "/config.txt");
    ...
    public boolean isMenuPanoramaParallaxEnabled() {
        return this.menuPanoramaParallax.getValue();
    }

    public void setMenuPanoramaParallaxEnabled(boolean enabled) {
        this.menuPanoramaParallax.setValue(enabled);
    }
    ...
    public enum ResolutionPreset {
        ...
        public String labelKey() {
            return "snappy.options.resolution." + this.id;
        }
    ...
    public enum MenuPanoramaMode {
        ...
        @NotNull
        public String labelKey() {
            return "snappy.options.menu_mode." + this.id;
        }
    ...
    public enum CycleInterval {
        ...
        @NotNull
        public String labelKey() {
            return "snappy.options.cycle_interval." + this.id;
        }
    ...
    public enum ScreenshotPreviewMode {
        ...
        @NotNull
        public String labelKey() {
            return "snappy.options.preview_mode." + this.id;
        }
    ...
    public enum BrowserSortMode {
        ...
        @NotNull
        public String labelKey() {
            return "snappy.browser.sort." + this.id;
        }
    ...
    public enum BrowserFilterMode {
        ...
        @NotNull
        public String labelKey() {
            return "snappy.browser.filter." + this.id;
        }
